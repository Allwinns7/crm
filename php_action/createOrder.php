...
if ($_POST) {
    ...
    $sql              = "INSERT INTO arm_sales (order_date, client_name, client_email, client_address, sub_total, vat, total_amount, discount, grand_total, paid, due, payment_type, payment_status, order_status) VALUES ('$orderDate', '$clientName', '$clientEmail', '$clientAddress', '$subTotalValue', '$vatValue', '$totalAmountValue', '$discount', '$grandTotalValue', '$paid', '$dueValue', $paymentType, $paymentStatus, 1)";
    $order_id;
    $orderStatus = false;
    ...
    for ($x = 0; $x < count($_POST['productName']); $x++) {
        ...
        while ($updateProductQuantityResult = $updateProductQuantityData->fetch_row()) {
            ...
            // add into order_item
            $orderItemSql = "INSERT INTO arm_sales_item (order_id, product_id, quantity, rate, total, order_item_status) 
