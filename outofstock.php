<?php
   ...
   $products_sql = $conn->query("SELECT * FROM `products` WHERE quantity=0 ORDER BY name ASC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <title>CRM | Out of Stock Products</title>
         ...
         <div class="content-wrapper">
            <section class="content-header">
               ...
               <div class="header-title">
                  ...
                  <small>Manage Out of Stock Products</small>
               </div>
            </section>
