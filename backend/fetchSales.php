...
$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM arm_sales WHERE order_status = 1";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	$itemCountResult = $conn->query($countOrderItemSql);
