                              ...
                              <div class="table-responsive">
                                <table class="table table-bordered">
                                  <tr>
                                    ...
                                    <?php if($row["order_converted"]==0) { ?>
                                      <div class="dropdown">
                                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Convert to 
                                        <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                          <li><a href="javascript:void(0);" onclick="convertOrder(<?php echo $_GET["id"];?>)">Sales Order</a></li>
                                          <li><a href="javascript:void(0);" onclick="rejectOrder(<?php echo $_GET["id"];?>)">Reject Quotation</a></li>
                                        </ul>
                                      </div>
                                      <br/>
                                    <?php } ?>
          ...
          $.ajax({
            ...
            success: function(data){
                ...
                if(result.status=='success') {
                   swal({
                     title: "Success",
                     text: "Converted to Order Successf  ully!!!",
                     icon: "success",
                     buttons: true,
                     dangerMode: true,
                   })
