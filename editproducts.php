<?php
   ...
   $pid = $_GET['id'];
   $products_sql = $conn->query("SELECT * FROM `products` WHERE id=$pid");
   $prodtctDetail = $products_sql->fetch_assoc();
   ...
   <body class="hold-transition sidebar-mini">
                              ...
                              <div class="row">
                                 <div class="col-sm-5">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-4">
                                          <input class="form-control" name="sku_code" type="text" id="sku_code" placeholder="SKU Code" tabindex="1" onkeyup="special_character_remove(this.value, 'product_id')" value="<?php echo $prodtctDetail['sku'];?>">
                                          <input type="hidden" name="eid" id="eid" value="<?php echo $prodtctDetail['id'];?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-4">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-8">
                                          <input class="form-control" name="product_name" type="text" id="product_name" placeholder="Product Name" required="" tabindex="1" onkeyup="special_character_remove(this.value, 'product_name')" value="<?php echo $prodtctDetail['name'];?>">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 ...
                                 <div class="col-sm-4">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-8">
                                          <textarea class="form-control" name="description" id="description" rows="3" placeholder="Details" tabindex="2"><?php echo $prodtctDetail['detail'];?></textarea>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="table-responsive" style="margin-top: 10px">
                                 <table class="table table-bordered table-hover">
                                    ...
                                    <tbody id="form-actions">
                                       <tr class="">
                                          <td class="">
                                             <input class="form-control text-right" name="cartoon_quantity" type="number" required="" placeholder="Product Per Cartoon" tabindex="5" min="0" value="<?php echo $prodtctDetail['quantity'];?>">
                                          </td>
                                          <td class="">
                                             <input class="form-control text-right" name="price" type="number" required="" placeholder="Sell Price" tabindex="6" min="0" value="<?php echo $prodtctDetail['sell_price'];?>">
                                          </td>
                                          <td class="">
                                             <input type="number" tabindex="7" class="form-control text-right" name="supplier_price" placeholder="Supplier Price" required="" min="0" value="<?php echo $prodtctDetail['supplier_price'];?>">
                                          </td>
                                          <td class="text-right">
                                             <select name="supplier_id" id="supplier_id" class="form-control" required="" tabindex="9">
                                                <option value="">Select One</option>
                                                <?php 
      ...
      <script>
         $(document).ready(function(){
            $('#category_id').val('<?php echo $prodtctDetail['category'];?>');
            $('#supplier_id').val('<?php echo $prodtctDetail['supplier'];?>');
         });
