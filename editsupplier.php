<?php
   ...
   $sid = $_GET['id'];
   $accounts = $conn->query("SELECT * FROM `suppliers` WHERE `id`=$sid");
                        ...
                        <form action="#" id="insert_supplier" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                           <div class="panel-body">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input class="form-control" name="supplier_name" id="supplier_name" type="text" placeholder="Supplier Name" required="" tabindex="1" onkeyup="special_character_remove(this.value, 'supplier_name')" value="<?php echo $accounts_exe['name'];?>">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <input class="form-control" name="mobile" id="mobile" type="text" placeholder="Supplier Mobile" required="" min="0" tabindex="2" onkeyup="onlynumber_allow(this.value,'mobile')" value="<?php echo $accounts_exe['mobile'];?>">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="address " class="col-sm-3 col-form-label text-right">Supplier Address</label>
                                 <div class="col-sm-6">
                                    <textarea class="form-control" name="address" id="address " rows="3" placeholder="Supplier Address" tabindex="3"><?php echo $accounts_exe['address'];?></textarea>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="details" class="col-sm-3 col-form-label text-right">Supplier Details</label>
                                 <div class="col-sm-6">
                                    <textarea class="form-control" name="details" id="details" rows="3" placeholder="Supplier Details" tabindex="4"><?php echo $accounts_exe['detail'];?></textarea>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="previous_balance" class="col-sm-3 col-form-label text-right">Previous Balance</label>
                                 <div class="col-sm-6">
                                    <input class="form-control" name="details" id="previous_balance" placeholder="Previous Balance" tabindex="5" type="number" value="<?php echo $accounts_exe['balance'];?>">
                                 </div>
                              </div>
                              <div class="form-group row">
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(result.status=='success') {
                              $('.resultDiv').html('<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>    Supplier Updated Successfully!</div>');
                        }
                        else {
                            $('.resultDiv').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Suppliers Failed to Updated !</div>');
                        }
                    },
                    error: function(){
